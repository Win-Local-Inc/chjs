...
class ChargifyCouponServiceTest extends TestCase
{
    public function testCouponServiceCreateSuccess()
    {
        ...
        $response = $this->getChargify()->coupon()->create($productFamilyId, [
            'name' => $name,
            'description' => $description,
            'code' => $code,
            'amount_in_cents' => $cents,
    ...
    public function testCouponServiceUpdateSuccess()
    {
        ...
        $response = $this->getChargify()->coupon()->update($productFamilyId, $couponId, [
            'name' => $name,
        ]);
    ...
    public function testCouponServiceArchiveSuccess()
    {
        ...
        $response = $this->getChargify()->coupon()->archive($productFamilyId, $couponId);
    ...
    public function testCouponServiceGetByIdSuccess()
    {
        ...
        $response = $this->getChargify()->coupon()->getCouponById($productFamilyId, $couponId);
    ...
    public function testCouponServiceGetByCodeSuccess()
    {
        ...
        $response = $this->getChargify()->coupon()->getCouponByCode($productFamilyId, $code);
    ...
    public function testCouponServiceValidateCodeSuccess()
    {
        ...
        $response = $this->getChargify()->coupon()->validateCode($productFamilyId, $code);
    ...
    public function testCouponServiceListCouponsSuccess()
    {
        ...
        $collection = $this->getChargify()->coupon()->listCoupons([
            'page' => 1,
            'per_page' => 2,
        ]);
    ...
    public function testCouponServiceListCouponsForProductFamilySuccess()
    {
        ...
        $collection = $this->getChargify()->coupon()->listCouponsForProductFamily($productFamilyId, [
            'page' => 1,
            'per_page' => 2,
        ]);
    ...
    public function testCouponServiceListCouponUsagesSuccess()
    {
        ...
        $collection = $this->getChargify()->coupon()->listCouponUsages($productFamilyId, $couponId);
    ...
    public function testCouponServiceCreateUpdateCouponSubcodesSuccess()
    {
        ...
        $response = $this->getChargify()->coupon()->createUpdateCouponSubcodes($couponId, $subcodes);
    ...
    public function testCouponServiceListCouponSubcodesSuccess()
    {
        ...
        $collection = $this->getChargify()->coupon()->listCouponSubcodes($couponId, [
            'page' => 1,
            'per_page' => 2,
        ]);

        $this->assertEquals($subcodes, $collection->toArray());
    }
    ...
    public function testCouponServiceDelteCouponSubcodeSuccess()
    {
        ...
        $this->getChargify()->coupon()->delteCouponSubcode($couponId, $subcode);
