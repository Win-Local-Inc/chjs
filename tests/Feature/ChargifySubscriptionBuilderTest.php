...
class ChargifySubscriptionBuilderTest extends TestCase
{
    ...
    public function testCreateSubscription()
    {
        ...
        $workspace->newSubscription($productPrice->product_price_handle, null)
        ...
        ray($workspace->subscription->product_price_handle);
    }

    public function testCreateSubscriptionWithCustomProductPrice()
    {
        $workspace = Workspace::factory()->create();
                ...
                ->push([
                    ...
                    'subscription' => [
                        ...
                        'product' => [
                            ...
                            'archived_at' => null,
                            'require_credit_card' => 'true',
                            'default_product_price_point_id' => 'abc123',
                            'product_price_point_id' => 'abc123',
                            'product_price_point_name' => Str::random(),
                            'product_price_point_handle' => 'abc123',
                            'created_at' => '2023-08-05 08:06:32 -0400',
                            'updated_at' => '2023-08-05 08:06:32 -0400',
                            'product_family' => [
                                'id' => Str::random(),
